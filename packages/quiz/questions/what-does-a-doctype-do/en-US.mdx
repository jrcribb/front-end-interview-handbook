...
A DTD defines how documents of a certain type should be structured (i.e. a `button` can contain a `span` but not a `div`), whereas a doctype declares what DTD a document _supposedly_ follows (i.e. this document follows the HTML DTD).
