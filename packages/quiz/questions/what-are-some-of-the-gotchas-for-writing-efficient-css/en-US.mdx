...
> [!TIP] BEM naturally produces efficient selectors
>
> The [BEM (Block Element Modifier)](https://en.bem.info/) methodology recommends that everything has a single class, and that any needed hierarchy is baked into the name of the class. This naturally makes selectors efficient and easy to override.
