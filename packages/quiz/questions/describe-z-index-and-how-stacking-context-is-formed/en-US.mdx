...
> [!NOTE] What exactly triggers a new stacking context
>
> The full set of conditions that qualify an element to create a stacking context is listed in this long set of [rules on MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_positioned_layout/Stacking_context#The_stacking_context).
