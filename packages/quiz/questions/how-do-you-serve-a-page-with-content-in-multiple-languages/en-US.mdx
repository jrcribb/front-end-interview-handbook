...
> [!NOTE] Assumption
>
> The question is about how to serve a page with content available in multiple languages, where the content within the page should be displayed in only one consistent language at a time.
